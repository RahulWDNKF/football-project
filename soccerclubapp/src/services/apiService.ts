...
//   sentAt: string;
// }): Promise<Email> => api.post('/Emails', payload);
export const createEmailApi = (payload: {
  playerId?: string;
  clubId?: string;
  recipientEmail: string;
  ...
  sentByScoutId: string;
  sentAt: string;
}): Promise<Email> => api.post('/Emails', {
  emailId: crypto.randomUUID(),        // ✅ always generate fresh UUID
  playerId: payload.playerId ?? null,
  clubId: payload.clubId ?? null,
  recipientEmail: payload.recipientEmail,
  subject: payload.subject,
  body: payload.body,
  sentByScoutId: payload.sentByScoutId,
